...
func NewLocalWriter(path string, compress bool, blockSize int) (*Writer, error) {
	...
	return NewWriter(fp, compress, blockSize)
}

func NewWriter(out io.WriteCloser, compress bool, blockSize int) (*Writer, error) {
	w := new(Writer)
	w.fp = out
